...
module Puppet::Parser::Functions
  ...
  @@processors = {
    ...
    :memory => single_arg('memory'),
    :memory_reservation => single_arg('memory-reservation'),
    :memory_swap => single_arg('memory-swap'),
    :memory_swappiness => single_arg('memory-swappiness'),
